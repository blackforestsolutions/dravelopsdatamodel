...
class TravelProviderMockIT {
    ...
    @Test
    void test_travelProvider_with_all_properties_populated_to_be_portable() {
    ...
    @Test
    void test_travelProvider_with_name_as_null_to_be_portable() {
    ...
    @Test
    void test_travelProvider_with_url_as_null_to_be_portable() {
        TravelProvider.TravelProviderBuilder testData = getTravelProviderBuilderWithNoEmptyFields();
    ...
    @Test
    void test_travelProvider_with_no_properties_populated_to_be_portable() {
