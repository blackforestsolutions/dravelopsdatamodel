...
class TravelPointMockIT {
    ...
    @Test
    void test_travelPoint_with_all_properties_populated_to_be_portable() {
    ...
    @Test
    void test_travelPoint_with_name_as_null_to_be_portable() {
    ...
    @Test
    void test_travelPoint_with_point_as_null_to_be_portable() {
        TravelPoint.TravelPointBuilder testData = getTravelPointBuilderWithNoEmptyFields();
    ...
    @Test
    void test_travelPoint_with_arrivalTime_as_null_to_be_portable() {
        TravelPoint.TravelPointBuilder testData = getTravelPointBuilderWithNoEmptyFields();
    ...
    @Test
    void test_travelPoint_with_departureTime_as_null_to_be_portable() {
        TravelPoint.TravelPointBuilder testData = getTravelPointBuilderWithNoEmptyFields();
    ...
    @Test
    void test_travelPoint_with_platform_as_null_to_be_portable() {
        TravelPoint.TravelPointBuilder testData = getTravelPointBuilderWithNoEmptyFields();
    ...
    @Test
    void test_travelPoint_with_no_properties_populated_to_be_portable() {
